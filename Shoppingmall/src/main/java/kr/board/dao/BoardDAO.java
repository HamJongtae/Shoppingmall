	...
	//좋아요 등록
		public void insertFav(BoardFavVO favVO)throws Exception{
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "INSERT INTO hboard_fav (board_num,mem_num) VALUES (?,?)";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
		...
		public int selectFavCount(int board_num)throws Exception{
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "SELECT COUNT(*) FROM hboard_fav WHERE board_num=?";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
				pstmt.setInt(1, board_num);
		...
		public BoardFavVO selectFav(BoardFavVO favVO)
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "SELECT * FROM hboard_fav WHERE board_num=? AND mem_num=?";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
				pstmt.setInt(1, favVO.getBoard_num());
		...
		public void deleteFav(BoardFavVO favVO)throws Exception{
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "DELETE FROM hboard_fav WHERE board_num=? AND mem_num=?";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
				pstmt.setInt(1, favVO.getBoard_num());
		...
		public List<BoardVO> getListBoardFav(int start, int end,
			...
			try {
				...
				sql = "SELECT * FROM (SELECT a.*, rownum rnum FROM "
					+ "(SELECT * FROM hboard b JOIN "
					+ "hmember m USING(mem_num) JOIN hboard_fav f "
		...
		public void insertReplyBoard(BoardReplyVO boardReply)
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "INSERT INTO hboard_reply (re_num,re_content,"
		...
		public int getReplyBoardCount(int board_num)
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문
				sql = "SELECT COUNT(*) FROM hboard_reply WHERE board_num=?";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
				pstmt.setInt(1, board_num);
		...
		public List<BoardReplyVO> getListReplyBoard(
			...
			try {
				...
				//SQL문 작성
				sql = "SELECT * FROM (SELECT a.*, rownum rnum FROM "
					+ "(SELECT * FROM hboard_reply JOIN hmember USING(mem_num) "
		...
		public BoardReplyVO getReplyBoard(int re_num)
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "SELECT * FROM hboard_reply WHERE re_num=?";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
		...
		public void updateReplyBoard(BoardReplyVO reply)
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "UPDATE hboard_reply SET re_content=?,"
		...
		public void deleteReplyBoard(int re_num)throws Exception{
			...
			try {
				...
				conn = DBUtil.getConnection();
				//SQL문 작성
				sql = "DELETE FROM hboard_reply WHERE re_num=?";
				//PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				//?에 데이터 바인딩
				pstmt.setInt(1, re_num);
